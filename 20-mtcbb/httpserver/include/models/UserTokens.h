...
class UserTokens
{
  public:
     ...
     */
    explicit UserTokens(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserTokens(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserTokens(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<UserTokens>;
    friend drogon::orm::BaseBuilder<UserTokens, true, true>;
    friend drogon::orm::BaseBuilder<UserTokens, true, false>;
    friend drogon::orm::BaseBuilder<UserTokens, false, true>;
    friend drogon::orm::BaseBuilder<UserTokens, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserTokens>;
#endif
