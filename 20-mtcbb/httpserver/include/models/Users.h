...
class Users
{
  public:
    struct Cols
    {
        ...
        static const std::string _update_at;
    ...
    const int32_t &getValueOfGender() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getGender() const noexcept;
    ///Set the value of the column gender
    void setGender(const int32_t &pGender) noexcept;
    ...
    /**  For column update_at  */
    ///Get the value of the column update_at, returns the default value if the column is null
    const ::trantor::Date &getValueOfUpdateAt() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getUpdateAt() const noexcept;
    ///Set the value of the column update_at
    void setUpdateAt(const ::trantor::Date &pUpdateAt) noexcept;
    void setUpdateAtToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> gender_;
    std::shared_ptr<std::string> email_;
    std::shared_ptr<::trantor::Date> createAt_;
    std::shared_ptr<::trantor::Date> updateAt_;
