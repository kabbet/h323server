...
cmake -DCMAKE_BUILD_TYPE=${BUILD_TYPE} \
      ...
      -DPostgreSQL_LIBRARY=$PG_HOME/lib/libpq.so \
      -DHIREDIS_ROOT=$HIREDIS_HOME \
      -DHIREDIS_INCLUDE_DIR=$HIREDIS_HOME/include \
      -DHIREDIS_LIBRARY=$HIREDIS_HOME/lib/libhiredis.so \
      -DCMAKE_POSITION_INDEPENDENT_CODE=ON \
